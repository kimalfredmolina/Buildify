...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    ...
    <div class="flex flex-col md:flex-row bg-white rounded-lg shadow-lg max-w-5xl w-full overflow-hidden">
        ...
        <div class="md:w-1/2 p-8 flex flex-col justify-center bg-slate-800">
            <h1 class="text-5xl font-bold mb-6 text-white animate-fade-in">EasyDraft</h1>
            <p class="text-lg text-white leading-relaxed animate-slide-in">
                EasyDraft is a user-friendly platform that lets you create and customize websites effortlessly. Edit headers, footers, colors, and layouts, upload media, and preview changes in real-time—no coding required. Build your perfect website today!
            </p>
        </div>
        <!-- Right Section -->
